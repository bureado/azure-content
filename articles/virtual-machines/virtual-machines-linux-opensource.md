...
# A guide to Linux & open source in Azure

Lorem ipsum.

## Up and running: Linux & FreeBSD

1. Choosing a Linux distribution from our endorsed distribution list
2. Choosing a Linux distribution from Marketplace
- [Azure Marketplace](http://azure.microsoft.com/marketplace/virtual-machines/)
3. Preparing and uploading your custom VHD
...
*In video*: [Creating a Linux VM](http://channel9.msdn.com/Blogs/Windows-Azure/Create-Linux-Virtual-Machine-Azure) and [Building a Linux VM](http://channel9.msdn.com/Blogs/Azure-Documentation-Shorts/Building-a-Linux-Virtual-Machine-Tutorial) and [Creating a custom Linux image with ARM](https://channel9.msdn.com/Blogs/Open/Creating-a-Linux-VM-from-a-custom-image-with-Azure-Resource-Manager-ARM)

## Onboarding open source applications in Azure

Here's a collection of articles that can help you get your application running on Linux in Azure.
...
*In video*: [Architecting enterprise-grade Linux solutions in Azure](https://azure.microsoft.com/en-us/documentation/videos/azurecon-2015-architecting-enterprise-grade-linux-solutions-in-azure-iaas/), [LAMP stack on Azure](http://channel9.msdn.com/Shows/Azure-Friday/LAMP-stack-on-Azure-VMs-with-Guy-Bowerman)

### Java DevOps
1. [Master List for Java Developers in Azure](https://azure.microsoft.com/en-us/blog/java-on-azure-a-great-selection-of-options/)
...
*Learn more*: [Open Source DevOps Practices](http://channel9.msdn.com/Series/Open-Source-for-DevOps-Practices)
...
*In video*: [Deploying a 2-container app in Azure with the Docker Extension](https://channel9.msdn.com/Blogs/Open/Deploying-a-2-container-application-in-Azure-with-Docker-Compose-and-the-Docker-VM-Extension)
...
*In video*: [Monitoring Linux compute workloads in Azure](http://channel9.msdn.com/Shows/Azure-Friday/Monitoring-Linux-Compute-workloads-within-an-Azure-Infrasturue)

*Learn more*: [MVA: Running Linux in Azure](http://channel9.msdn.com/Shows/MVA-Running-Linux-in-Azure)
...
## Support and Microsoft's open source community
...
1. Microsoft support documentation
  ...
  - TBD LINK TO SUPPORT POLICY
	Link to Why MS + OSS markruss presentation, link to https://azure.microsoft.com/en-us/trial/free-trial-open-source/ and link to external engineering site.
